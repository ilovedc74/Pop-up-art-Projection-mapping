...
void ofApp::setup(){
    ...
    sceneTangle = new SceneTangle();
    sceneTangle ->setup();
    piMapper.registerFboSource(sceneTangle);
    
    sceneRainbow = new SceneRainbow();
    sceneRainbow ->setup();
    piMapper.registerFboSource(sceneRainbow);

    sceneLaser = new SceneLaser();
    sceneLaser ->setup();
    piMapper.registerFboSource(sceneLaser);
...
//    dummyObjects.load("dummy_cubes.png");
